...
class Mesh2:
    ...
    def __init__(self, file_path=None, datatype=None):
        ...
        # self.__device = o3d.core.Device("CPU:0")
        # self.__dtype = o3d.core.float32
    ...
    def write(self, path):
        if self.__type == "PointCloud":
            o3d.io.write_point_cloud(path, self.__pcd)
            ...
            o3d.io.write_triangle_mesh(path, self.__pcd)
            img_path = path[:-4] + "_0.png"
            new_img_path = path[:-3] + "png"
